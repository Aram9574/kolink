...
/**
 * Encrypt LinkedIn tokens for storage
 */
...
export interface EncryptedLinkedInTokens {
  accessTokenEncrypted: string;
  refreshTokenEncrypted: string;
  expiresAt?: string;
}

export function encryptLinkedInTokens(tokens: LinkedInTokens): EncryptedLinkedInTokens {
  return {
...
/**
 * Decrypt LinkedIn tokens from storage
 */
export function decryptLinkedInTokens(
  encrypted: EncryptedLinkedInTokens
): LinkedInTokens | null {
  const accessToken = decryptToken(encrypted.accessTokenEncrypted);
  const refreshToken = decryptToken(encrypted.refreshTokenEncrypted);
